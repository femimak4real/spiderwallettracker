...
def _check_rug_risk(mint: str) -> dict:
    ...
    try:
        ...
        # Invert danger -> safety, then apply bonuses/penalties in the
        # direction that actually makes sense: good signals raise safety,
        # a pile of warning/danger flags lowers it further.
        safety = 100 - danger
...
def health():
    ...
    checks["cache_sizes"] = {
        ...
        "jupiter_symbol_map":   len(_jupiter_token_map),
